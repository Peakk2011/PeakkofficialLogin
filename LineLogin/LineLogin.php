...
{
    #### change your id
    private const CLIENT_ID = '2006502234';
    private const CLIENT_SECRET = '2222701e8b748d71466ca0e6596d2089';
    private const REDIRECT_URL = 'http://localhost/PeakkofficialLogin/includes/callback.php';
